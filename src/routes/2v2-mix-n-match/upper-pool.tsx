...
const UPPER_POOL: BracketPool = 'upper'
...
const loadUpperPool = createServerFn({ method: 'GET' }).handler(async () => {
  ...
  const bracketGames = await db
    ...
    .where(eq(twoVsTwoBracketGames.pool, UPPER_POOL))
...
const saveUpperPoolMatch = createServerFn({ method: 'POST' })
  .inputValidator((input: SaveUpperPoolMatchInput) => input)
  .handler(async ({ data }) => {
    ...
    await db.transaction(async (tx) => {
      ...
      if (data.matchKey === 'sf1' || data.matchKey === 'sf2') {
        await tx
          ...
          .where(
            and(
              eq(twoVsTwoBracketGames.pool, UPPER_POOL),
...
export const Route = createFileRoute('/2v2-mix-n-match/upper-pool')({
  head: () => ({
    meta: [{ title: 'Upper Pool | 2v2 Mix n\' Match Mini Cup | JustPlay' }],
  }),
  validateSearch: (search: Record<string, unknown>) => ({
    edit: typeof search.edit === 'string' ? search.edit : undefined,
  }),
  loader: async () => loadUpperPool(),
  component: UpperPoolPage,
})

function UpperPoolPage() {
  const { rankedPlayers, bracketGames: initialBracketGames } = Route.useLoaderData()
  const search = Route.useSearch()
  const upperPlayers = rankedPlayers.slice(0, 8)
  const teams = buildTeams(upperPlayers)
  const hasCompletePool = upperPlayers.length === 8
  ...
  const onSaveMatch = async (matchKey: BracketMatchKey, leftTeam: PoolTeam | null, rightTeam: PoolTeam | null) => {
    ...
    try {
      ...
      const updated = await saveUpperPoolMatch({
        data: {
          matchKey,
  ...
  return (
    <section className="container py-4">
      <header className="mb-4">
        <h1 className="h2 mb-1">Upper Pool (Top 8)</h1>
        <p className="text-body-secondary mb-0">
          Teams are assigned strongest with lowest: A(1,8), B(2,7), C(3,6), D(4,5).
        </p>
      </header>
      ...
      {!hasCompletePool ? (
        <div className="alert alert-warning" role="alert">
          TBC: Need at least 8 ranked players to complete the Upper Pool bracket.
        </div>
      ) : null}
          ...
          <div className="row g-3">
            <div className="col-12 col-lg-6">
              <article className="border rounded p-3 h-100">
                ...
                <div className="row g-2 mb-3">
                  <div className="col-6">
                    <label htmlFor="sf1-score-a" className="form-label small mb-1">Team {teamA.label} score</label>
                    <input
                      id="sf1-score-a"
                  ...
                  <div className="col-6">
                    <label htmlFor="sf1-score-b" className="form-label small mb-1">Team {teamD.label} score</label>
                    <input
                      id="sf1-score-b"
                      className="form-control"
                      type="number"
            ...
            <div className="col-12 col-lg-6">
              <article className="border rounded p-3 h-100">
                ...
                <div className="row g-2 mb-3">
                  <div className="col-6">
                    <label htmlFor="sf2-score-a" className="form-label small mb-1">Team {teamB.label} score</label>
                    <input
                      id="sf2-score-a"
                      className="form-control"
                      type="number"
                  ...
                  <div className="col-6">
                    <label htmlFor="sf2-score-b" className="form-label small mb-1">Team {teamC.label} score</label>
                    <input
                      id="sf2-score-b"
                      className="form-control"
                      type="number"
            ...
            <div className="col-12 col-lg-6">
              <article className="border rounded p-3 h-100">
                ...
                <div className="row g-2 mb-3">
                  <div className="col-6">
                    <label htmlFor="final-score-a" className="form-label small mb-1">Winner SF1 score</label>
                    <input
                      id="final-score-a"
                      className="form-control"
                      type="number"
                  ...
                  <div className="col-6">
                    <label htmlFor="final-score-b" className="form-label small mb-1">Winner SF2 score</label>
                    <input
                      id="final-score-b"
                      className="form-control"
                      type="number"
            ...
            <div className="col-12 col-lg-6">
              <article className="border rounded p-3 h-100">
                ...
                <div className="row g-2 mb-3">
                  <div className="col-6">
                    <label htmlFor="third-score-a" className="form-label small mb-1">Loser SF1 score</label>
                    <input
                      id="third-score-a"
                      className="form-control"
                      type="number"
                  ...
                  <div className="col-6">
                    <label htmlFor="third-score-b" className="form-label small mb-1">Loser SF2 score</label>
                    <input
                      id="third-score-b"
                      className="form-control"
                      type="number"
